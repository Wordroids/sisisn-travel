                    ...
                    <div class="flex flex-col py-3 space-y-3 md:flex-row md:items-center md:justify-between md:space-y-0 md:space-x-4">
                        <div class="flex items-center flex-1 space-x-4">
                            <h5>
                                ...
                                <span class="test:text-white">1,356,546</span>
                            </h5>
                            <h5>
                                <span class="text-gray-500">Projects:</span>
                                <span class="test:text-white">884</span>
                            </h5>
                        </div>
                        <div class="flex flex-col items-start flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                            <button type="button" class="inline-flex items-center justify-center flex-shrink-0 px-3 py-2 text-xs font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 test:focus:ring-gray-700 test:bg-gray-800 test:text-gray-400 test:border-gray-600 test:hover:text-white test:hover:bg-gray-700">
                            ...
                            <tr>
                                <th scope="col" class="p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-all" type="checkbox" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 test:focus:ring-primary-600 test:ring-offset-gray-800 focus:ring-2 test:bg-gray-700 test:border-gray-600">
                        ...
                        <tbody>
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                <td class="w-4 px-4 py-3">
                                    <div class="flex items-center">
                                        <input id="checkbox-table-search-1" type="checkbox" onclick="event.stopPropagation()" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 test:focus:ring-primary-600 test:ring-offset-gray-800 focus:ring-2 test:bg-gray-700 test:border-gray-600">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <div class="flex items-center space-x-1.5">
                                        <a class="transition hover:text-gray-900 test:hover:text-white" href="#">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        ...
                                        <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-primary-300 test:peer-focus:ring-primary-800 test:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all test:border-gray-600 peer-checked:bg-primary-600"></div>
                                    </label>
                                </td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <div class="flex items-center">
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2">
                                    <div class="inline-flex items-center bg-gray-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded test:bg-gray-700 test:text-gray-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-1" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-1" type="button" data-dropdown-toggle="dropdown-1" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-1" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-1">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2">
                                    <div class="inline-flex items-center bg-indigo-100 text-indigo-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded test:bg-indigo-900 test:text-indigo-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-1" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-2" type="button" data-dropdown-toggle="dropdown-2" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-2" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-2">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-3" type="button" data-dropdown-toggle="dropdown-3" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-3" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-3">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2">20 Nov 2022</td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-4" type="button" data-dropdown-toggle="dropdown-4" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-4" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-4">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2">20 Nov 2022</td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-5" type="button" data-dropdown-toggle="dropdown-5" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-5" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-5">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-6" type="button" data-dropdown-toggle="dropdown-6" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-6" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-6">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2">27 Nov 2022</td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-7" type="button" data-dropdown-toggle="dropdown-7" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-7" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-7">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2">20 Nov 2022</td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-8" type="button" data-dropdown-toggle="dropdown-8" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-8" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-8">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
                            ...
                            <tr class="border-b test:border-gray-600 hover:bg-gray-100 test:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2">20 Nov 2022</td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap test:text-white">
                                    <button id="dropdown-button-9" type="button" data-dropdown-toggle="dropdown-9" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-800 hover:bg-gray-200 test:hover:bg-gray-700 focus:outline-none test:text-gray-400 test:hover:text-gray-100">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-9" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 test:bg-gray-700 test:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 test:text-gray-200" aria-labelledby="dropdown-button-9">
                                            <li>
                                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 test:hover:bg-gray-600 test:hover:text-white">Show</a>
                                            </li>
                                            <li>
