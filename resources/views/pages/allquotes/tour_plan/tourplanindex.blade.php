    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-semibold text-gray-800">
                Tour Plan Vouchers for {{ $groupQuotation->name ?? 'Group' }}
            </h2>
            <div class="flex space-x-2">
                <a href="{{ route('tour_plan_vouchers.select', ['main_ref' => $main_ref]) }}"
                ...
                <a href="{{ route('group_quotations.group_vouchers', ['main_ref' => $main_ref]) }}"
                        ...
                        @foreach ($tourPlans as $plan)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                    <a href="{{ route('tour_plan_vouchers.pdf', ['main_ref' => $main_ref, 'id' => $plan->id]) }}"
                                    ...
                                    <a href="{{ route('tour_plan_vouchers.edit', ['main_ref' => $main_ref, 'id' => $plan->id]) }}"
                                    ...
                                    <form class="inline-block"
                                        action="{{ route('tour_plan_vouchers.destroy', ['main_ref' => $main_ref, 'id' => $plan->id]) }}"
                                        method="POST"
        ...
        @else
            <div class="bg-white shadow overflow-hidden rounded-lg p-6 text-center">
                ...
                <p class="mt-1 text-gray-500">Start by creating your first tour plan for this group.</p>
                <div class="mt-6">
                    <a href="{{ route('tour_plan_vouchers.create', ['main_ref' => $main_ref]) }}"
                        class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
