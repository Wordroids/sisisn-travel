                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-xl font-semibold text-gray-800">
                            Select Voucher Type for {{ $quotation->booking_reference }}
                        </h2>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-blue-700">
                                    Generate vouchers for individual tour: {{ $quotation->booking_reference }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                        ...
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-500 mb-4">Generate vouchers for all hotel accommodations in this tour.</p>
                                <a href="{{ route('quotations.hotel_vouchers', ['quotation' => $quotation->id]) }}"
                        ...
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-500 mb-4">Generate vouchers for all meal arrangements in this tour.</p>
                                <a href="{{ route('individual_meal_vouchers.index', ['quotation' => $quotation->id]) }}"
                        ...
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-500 mb-4">Generate detailed tour plan voucher with daily activities and itinerary.</p>
