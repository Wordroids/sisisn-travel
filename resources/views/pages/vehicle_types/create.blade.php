<x-app-layout>
    <div class="max-w-4xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
        <h2 class="text-2xl font-semibold mb-4">Add Vehicle Type</h2>
        ...
        <form method="POST" action="{{ route('vehicle_types.store') }}">
            ...
            <input type="number" step="0.01" name="default_rate" class="block w-full border-gray-300 rounded-md shadow-sm p-2" required>
