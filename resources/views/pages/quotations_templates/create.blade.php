        ...
        <form method="POST" action="{{ route('quotations_templates.store') }}" id="templateForm">
            ...
            <div class="mb-8 bg-gray-50 p-6 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="template_name" class="block text-sm font-medium text-gray-700 mb-1">Template
                            Name</label>
                        ...
                        <tbody id="sites-section">
                            <tr class="site-entry hover:bg-gray-50">
                                <td class="py-3 px-4 border-b">
                                    <input type="text" name="site_seeings[0][name]"
                                        class="block w-full border-gray-300 rounded-md shadow-sm">
                                    <input type="hidden" name="site_seeings[0][type]" value="site">
                                </td>
                                <td class="py-3 px-4 border-b">
                                    <input type="number" name="site_seeings[0][unit_price]"
                                        class="site-unit-price block w-full border-gray-300 rounded-md shadow-sm"
                                        step="0.01" min="0">
                                </td>
                                <td class="py-3 px-4 border-b">
                                    <input type="number" name="site_seeings[0][quantity]" value="1"
                                        class="site-quantity block w-full border-gray-300 rounded-md shadow-sm"
                                        min="1">
                                </td>
                                <td class="py-3 px-4 border-b">
                            ...
                            <tr class="site-extra-entry hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 border-b">
                                    <input type="number" name="site_extras[0][unit_price]"
                                        class="extra-unit-price block w-full border-gray-300 rounded-md shadow-sm"
                                        step="0.01" min="0">
                                </td>
                                <td class="py-3 px-4 border-b">
                                    <input type="number" name="site_extras[0][quantity]" value="1"
                                        class="extra-quantity block w-full border-gray-300 rounded-md shadow-sm"
                                        min="1">
                                </td>
                                <td class="py-3 px-4 border-b">
                            ...
                            <tr class="extra-entry hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 border-b">
                                    <input type="number" name="extras[0][unit_price]"
                                        class="quotation-unit-price block w-full border-gray-300 rounded-md shadow-sm"
                                        step="0.01" min="0">
                                </td>
                                <td class="py-3 px-4 border-b">
                                    <input type="number" name="extras[0][quantity_per_pax]" value="1"
                                        class="quotation-quantity block w-full border-gray-300 rounded-md shadow-sm"
                                        min="1">
                                </td>
                                <td class="py-3 px-4 border-b">
        ...
        document.addEventListener("DOMContentLoaded", function() {
                                ...
                                <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-1 gap-3 mb-3">
                                            <div>
                                                ...
                                                <input type="number" name="accommodations[${cardIndex}][additional_rooms][driver][per_night_cost]" 
                                                    class="block w-full border-gray-300 rounded-md shadow-sm text-center" step="0.01">
                                            </div>
                                        </div>
                                        <div class="flex gap-4 items-center">
                                            <label class="font-medium text-gray-700 text-sm">Provided by hotel?</label>
                                            <div class="flex items-center">
                                                <input type="radio" id="driver_provided_by_hotel_yes_${cardIndex}" name="accommodations[${cardIndex}][additional_rooms][driver][provided_by_hotel]" value="1" class="mr-2">
                                                <label for="driver_provided_by_hotel_yes_${cardIndex}" class="text-sm">Yes</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input type="radio" id="driver_provided_by_hotel_no_${cardIndex}" name="accommodations[${cardIndex}][additional_rooms][driver][provided_by_hotel]" value="0" class="mr-2" checked>
                                                <label for="driver_provided_by_hotel_no_${cardIndex}" class="text-sm">No</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-md shadow-sm">
                                        ...
                                        <div class="flex gap-4 items-center">
                                            <label class="font-medium text-gray-700 text-sm">Provided by hotel?</label>
                                            <div class="flex items-center">
                                                <input type="radio" id="guide_provided_by_hotel_yes_${cardIndex}" name="accommodations[${cardIndex}][additional_rooms][guide][provided_by_hotel]" value="1" class="mr-2">
                                                <label for="guide_provided_by_hotel_yes_${cardIndex}" class="text-sm">Yes</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input type="radio" id="guide_provided_by_hotel_no_${cardIndex}" name="accommodations[${cardIndex}][additional_rooms][guide][provided_by_hotel]" value="0" class="mr-2" checked>
                                                <label for="guide_provided_by_hotel_no_${cardIndex}" class="text-sm">No</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            document.getElementById('templateForm').addEventListener('submit', function() {
                ...
                document.querySelectorAll(
                    '.site-price-per-adult, .extra-price-per-adult, .quotation-total-price').forEach(
                    input => {
